# -*- coding: utf-8 -*-
"""
NodeLocalizer - Node-level leak localization deep learning model
Utilizes LTFM region features + sensitivity vectors to predict the specific leak node

Two-stage approach:
  Stage 1: Train LTFM (Global/Region detection, completed, parameters frozen)
...
class NodeLocalizer(nn.Module):
    ...
    Core idea: 
    Treat leak localization as a "multi-view query-matching" problem.
    1. Multi-Head Attention: Multi-view matching ("empirical judgment").
    2. Physics Bias: Physical sensitivity constraint ("theoretical judgment").
    
    Regression: Remove dynamic gating, use robust static physics bias.
    """
